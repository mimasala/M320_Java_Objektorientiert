...
public class BeatmapTUI extends TUI {
    ...
    public void startMenu() {
        ...
        switch (inp) {
            ...
            case "5" -> {
                service.deleteBeatmapByTitle(InputService.getString("Enter title: "));
            }
            case"6" -> {
                OsuLog.info(service.searchBeatmap(InputService.getString("Enter search term: ")));
            }
            case "7" -> {
                service.addBeatmaps(InputService.getString("Enter title: "));
            }
            case "8" -> {
